...
"W    WWWWWWWWW    WWWWWWWWWWWWWWWWWWWW    WWWWWWWW                                 W",
"W                                                                                  W",
"W                                                                                  W",
"W                                                                                  W",
"WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW",
...
"W        WWWW                                                                W",
"W        WWWW                                                                W",
"W    WWWWWWWWWWWWWWWWWWWWWWWW    WWWWWWWWWWWWWWWW            WWWW            W",
"W    WWWWWWWWWWWWWWWWWWWWWWWW    WWWWWWWWWWWWWWWW            WWWW            W",
"W    WWWWWWWWWWWWWWWWWWWWWWWW    WWWWWWWWWWWWWWWW            WWWW            W",
"W    WWWWWWWWWWWWWWWWWWWWWWWW    WWWWWWWWWWWWWWWW            WWWW            W",
"W                                                                            W",
...
player2SpriteMaskRectangle = player2Sprite
...
while True:
    while state == "got tagged":
        ...
        drawText(roomWidth/2,100,white,basic,22,"YOU DIED")
        drawText(roomWidth/2,150,white,basic,22,"PRESS 1 TO CHANGE MAP")
        drawText(roomWidth/2,200,white,basic,22,"PRESS 2 TO CHANGE PLAY AGAIN")
        drawText(roomWidth/2,250,white,basic,22,"SCORE IS EUQAL TO:")
        drawText(roomWidth/2,300,white,basic,22,"PLAYER ONE: " + str(score[0]))
        drawText(roomWidth/2,350,white,basic,22,"PLAYER TWO: " + str(score[1]))
    ...
    while state == "playing":
        ...
        drawText(roomWidth - 200,250,black,basic,22,str(distanceApartMeters) + " Meters")
