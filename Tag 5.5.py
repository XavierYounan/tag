...
while True:
    while state == "game finished":
        ...
        drawText(roomWidthStart/2,100,black,basic,22,"GAME OVER")
        drawText(roomWidthStart/2,100,black,basic,22,"PLAYER "  )
    ...
    while state == "got tagged":
        ...
        if roundsUntillSwitch == 0:
            ...
            if keyListNumbers[1]:
                ...
                wallCoordList,player1SpawnPoint,player2SpawnPoint,player1Pos,player2Pos,roomWidth,roomHeight = loadMap(lastMap)
                gameDisplay = pygame.display.set_mode((roomWidth,roomHeight))
                state = "playing"
