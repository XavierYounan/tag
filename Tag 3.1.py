...
#Speed
player1Speed = 8        #[ x speed, jump height]
player2Speed = 8        #[ x speed, jump height]

#Initilise bad countdown, never works because the code doesnt alwyas run at max speed
tagSwitchTime = 100 #in secconds
...
while True:
    ...
    #Draw time remaning
    print(tagTimerCountdown)
    a = tagTimerCountdown 
    while(a % FPS) != 0:
        a-=1        
    tagTimerCountdownDisplay = int(a/FPS + 1)
    drawText(200,200,white,basic,22,str(tagTimerCountdownDisplay))
