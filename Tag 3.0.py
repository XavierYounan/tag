...
while True:
    ...
    #print("PLAYER ONE -- The actual position change is: " +str(player1ActualPosChange) + " The float pos change is " + str(player1PosChange))
    #print("PLAYER TWO -- The actual position change is: " +str(player2ActualPosChange) + " The float pos change is " + str(player2PosChange))
